...
### Iusse of lecture 2: Question -> Input data -> Features ->...->parameters->evaluation
...
### Lecture 5, slide 7 discuss the proportions of sets in the cases of large, medium, and small size
...
### Issues of Lecture 6
### Predictive value of a positive; Accuracy; Senetivity;...

# Q5
## Suppose that we have created a machine learning algorithm that predicts whether a link will be clicked with 
## 99% sensitivity and 99% specificity. The rate the link is clicked is 1/1000 of visits to a website. 
## If we predict the link will be clicked on a specific visit, what is the probability it will actually be clicked?
### Changed from the example in Lecture 06, slide 5
### Positive Predict Value: 9%