...
gbmOSE <- sum(cvPred == CVSet$classe)/nrow(CVSet)
```
We produced the prediction values based on the sample data for the cross validation. In our work, the estimated out of sample error is `r round((1 - gbmOSE), digits=2)`.
